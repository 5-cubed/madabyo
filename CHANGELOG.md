...
### Other
- feat(panes): preserve tab scroll positions

## [0.10.0] - 2026-09-18

### Other
- feat(frontmatter): render standard YAML metadata
- Render leading frontmatter as a table

## [0.9.3] - 2026-09-08

### Other
- fix(sidebar): preserve folder collapse state across Windows paths
